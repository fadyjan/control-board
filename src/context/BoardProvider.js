...
export const BoardProvider = ({ children }) => {
  const [selectedQuestion, setSelectedQuestion] = useState({ name: "ISSUE TYPE ?" ,id : 1,});
  ...
  const DepartmentArray = [
    'Administrative', 'Finance' ,'Accounting' , 'Sales' , 'Marketing' , 'Logistic' , 'Human Resources', 'Supplier Security'
];
